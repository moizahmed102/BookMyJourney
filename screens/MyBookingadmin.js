      ...
      <View style={styles.buttonContainer}>
        <Button
          ...
          style={[
            ...
            {
              backgroundColor:
                selectedBookingType === "hotel" ? "#008080" : "#fff",
            },
          ]}
          labelStyle={{
            ...styles.buttonText,
            color: selectedBookingType === "hotel" ? "#fff" : "#008080",
          }}
        >
          Hotels
        </Button>
        ...
        <Button
          ...
          style={[
            ...
            {
              backgroundColor:
                selectedBookingType === "bus" ? "#008080" : "#fff",
            },
          ]}
          labelStyle={{
            ...styles.buttonText,
            color: selectedBookingType === "bus" ? "#fff" : "#008080",
          }}
        >
          Busses
        </Button>
        ...
        <Button
          ...
          style={[
            ...
            {
              backgroundColor:
                selectedBookingType === "guide" ? "#008080" : "#fff",
            },
          ]}
          labelStyle={{
            ...styles.buttonText,
            color: selectedBookingType === "guide" ? "#fff" : "#008080",
          }}
        >
          Guides
        </Button>
